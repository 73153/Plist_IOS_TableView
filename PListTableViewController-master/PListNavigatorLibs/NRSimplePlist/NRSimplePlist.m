...
//Extracts a value from plist passed as the first parameter
...
//Changing a value in the plist (passed as the first parameter) to the key passed. Generic method that includes the most common things
